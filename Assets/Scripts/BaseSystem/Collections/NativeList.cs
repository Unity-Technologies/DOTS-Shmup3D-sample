        ...
        where T : struct
    {
        ...
        public void Add(T element)
        {
            ...
            if (Capacity < Length + 1)
                m_ListData->Add(element); // This changes its Capacity..
            else                          // so I made a workaround below
            {                             // AddNoReside doesn't work. I did that directly.
                UnsafeUtility.WriteArrayElement(m_ListData->Ptr, m_ListData->Length, element);
                m_ListData->Length += 1;
            }
        }
